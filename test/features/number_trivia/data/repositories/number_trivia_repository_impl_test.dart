...
import 'package:flutter_clean_architecture_sample/features/number_trivia/data/datasources/number_trivia_local_datasource.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test(
      'should check if device is connected',
      () async {
        //arrange
        when(mockNetworkInfo.isConnected).thenAnswer((_) async => true);
        //act
    ...
    runTestsOnline(() {
      ...
      test(
        'should cache the data locally when the call to remote data source is sucessfull',
        () async {
          //arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
              .thenAnswer((_) async => tNumberTriviaModel);
